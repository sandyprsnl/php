...
<?php
   ...
   Edit Users <small>Edit-Users Details</small></h1>
    <hr>
    <ol class="breadcrumb">
  ...
  <li class="active"><i class=" fa fa-user"></i> Edit-Users</li>
...
<?php
      ...
      //  $salt_row=mysqli_fetch_array($salt_run);
       ...
       // $insert_password=crypt($password,$salt);
        ...
        $update_query="UPDATE `users` SET `first_name` = '$first_name', `last_name` = '$last_name', `img` = '$img', `password` = '$password', `role` = ' $role', `details` = '$details' WHERE `users`.`id` =$edit_id";
 ...
 <div class="form-group">
  ...
  <label for="role">Role:*</label>
               <select name="role" id="role" class="form-control">
                 <option value="auther"<?php if($e_role =='auther'){
  echo"Selected";
}?> >Auther</option>
