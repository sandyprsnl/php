<footer class="text-center">
  Copyright &copy; by <a href="#"> Sandeep Bhardwaj</a> From 2017-<?php echo date('Y');
...
$(document).ready(function(){
  ...
  content_css: [
    ...
    "//www.tiny.cloud/css/content-standard.min.css"
               ...
               <?php
               $media_queruy="SELECT * FROM media ORDER BY id DESC";
               $media_run=mysqli_query($con,$media_queruy);
